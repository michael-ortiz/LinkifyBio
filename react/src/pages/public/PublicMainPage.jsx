  ...
  return (
    <Container maxWidth="false" sx={{ height: "100vh", width: "100vw" }}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create a centralized public page for all your social media links. Share this link in your bio and let your followers access all your platforms from one place."
        />
      </Helmet>
      ...
      >
        ...
        >
          ...
          >
            <SocialIcon
              url="https://github.com/michael-ortiz/LinkifyBio"
              bgColor="transparent"
              fgColor="black"
            />
            Open Source Project
