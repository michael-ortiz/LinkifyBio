          ...
          <Box display="flex" justifyContent="center" alignItems="center">
            ...
            >
              ...
              >
                ...
                <h1 style={{ color: this.state.pageColors.textColor }}>
                  {this.state.bioInfo.name}
                </h1>
                <p style={{ color: this.state.pageColors.textColor }}>
                  {this.state.bioInfo.descriptionTitle}
                </p>
              </Box>
                ...
                {this.state.socialMediaLinks.map((link, index) => (
                  <Box key={index} margin={1}>
                    <SocialIcon
                      url={link.url}
                      bgColor="transparent"
                      fgColor={this.state.pageColors.socialIconsColor}
                    />
                  </Box>
                ))}
              </Box>
                    ...
                    >
                      ...
                      >
                        <SocialIcon
                          url={link.url}
                          bgColor="transparent"
                          fgColor={this.state.pageColors.buttonLinkIconColor}
