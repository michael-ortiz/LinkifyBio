...
function CreatePage() {
    ...
    const handleSubmit = async () => {
        ...
        createPagte(id, name, descriptionTitle, selectedImage)
            .then(() => {
            ...
            <Box sx={MainBoxStyle}>
                ...
                <Box display="flex" justifyContent="left" alignItems="center">
                    ...
                    <Breadcrumbs separator="›" aria-label="breadcrumb">
                        ...
                        <Link underline="hover" color="inherit" href="/console/page/create/alias">
                            {id}
                        </Link>
                ...
                >
                    <Avatar
                        ...
                        draggable="false"
                    />
                    <Button variant="contained" color="primary" onClick={openPicEditor}>Select Picture</Button>
                </Box>
